...
This directory is the project-management and decision record for `larainspect`.
...
- Update the long-term memory when a design decision becomes stable.
- Add or split task files when a phase becomes too large to review comfortably.
- Treat heuristics, confirmed findings, and unknowns as separate output classes.
